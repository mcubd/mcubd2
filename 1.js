...
h45.style.cssText = 'margin-top:0px;margin-left:40px;margin-bottom:10px'
document.getElementById('intro').append(h45)


var h46 = document.createElement("h6");
h46.innerText="6.Marvel's The Avengers (2012)"
h46.style.cssText = 'margin-top:0px;margin-left:40px;margin-bottom:10px'
