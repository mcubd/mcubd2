...
order.style.cssText = 'padding: 8px   calc(100vw*.06) 15px calc(100vw*.06);background-color: rgba(154, 238, 29,0.1);margin-bottom: 165px;border-radius:10px ;'

hr.style.cssText = 'margin: 0;border-color: #473737;'

h4.style.cssText = 'opacity: 0.5;'
